...
class AlbumActivity : BaseActivity() {
    ...
    var list: androidx.recyclerview.widget.RecyclerView? = null
    ...
    private fun initializeList() {
        ...
        list?.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(context, androidx.recyclerview.widget.LinearLayoutManager.VERTICAL, false);
