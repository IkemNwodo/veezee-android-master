...
class AlbumsTrackListActivity : BaseActivity() {
    ...
    private var albumTrackRecycler: androidx.recyclerview.widget.RecyclerView? = null;
...
//    }
    ...
    private fun initList() {
        albumTrackRecycler?.layoutManager = androidx.recyclerview.widget.GridLayoutManager(context, GRID_SYSTEM_SPAN_COUNT, androidx.recyclerview.widget.GridLayoutManager.VERTICAL, false);
