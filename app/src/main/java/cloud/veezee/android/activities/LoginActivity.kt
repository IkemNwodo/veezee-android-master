...
//    }
    ...
    private fun registerDialog(view: View) {
        ...
        val cancel = view.findViewById<androidx.cardview.widget.CardView>(R.id.dialog_register_cancel);
    ...
    private fun loginDialog(view: View) {
        ...
        loginLoading = view.findViewById(R.id.dialog_register_submit_loading)
        val cancel = view.findViewById<androidx.cardview.widget.CardView>(R.id.dialog_login_cancel);
