...
class AlbumVerticalListAdapter(var album: Album, var context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
...
//                (context as AlbumActivity).openBottomPlayer();
    ...
    //ViewHolders
    inner class MainRowViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {

        val container: androidx.cardview.widget.CardView = itemView.findViewById(R.id.album_track_container)!!;
