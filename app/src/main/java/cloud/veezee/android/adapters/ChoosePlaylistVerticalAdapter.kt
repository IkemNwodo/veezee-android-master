...
class ChoosePlaylistVerticalAdapter(val context: Context, val list: ArrayList<Album>) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
    ...
    inner class CreatePlaylistViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {

        private val plus: ImageView = itemView.findViewById(R.id.plus_image)!!;
        val container: androidx.cardview.widget.CardView = itemView.findViewById(R.id.plus_container)!!;
    ...
    inner class MainViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
        val container: androidx.cardview.widget.CardView = itemView.findViewById(R.id.playlist_item_container)!!;
