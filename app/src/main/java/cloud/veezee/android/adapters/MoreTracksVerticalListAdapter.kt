...
class MoreTracksVerticalListAdapter(val context: Context, private val list: ArrayList<Any>, recyclerView: androidx.recyclerview.widget.RecyclerView?) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
...
//                    (context as AlbumsTrackListActivity).openBottomPlayer();
    ...
    inner class MainItemViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
        val container: androidx.cardview.widget.CardView = itemView.findViewById(R.id.album_item_container)!!;
