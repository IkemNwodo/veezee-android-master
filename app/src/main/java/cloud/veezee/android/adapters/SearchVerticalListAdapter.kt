...
class SearchVerticalListAdapter(val context: Context, private val searchItems: ArrayList<HomePageItem>) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
...
//                    (context as HomePageActivity).openBottomPlayer();
    ...
    inner class TrackViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
    ...
    inner class HeaderViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
