...
public class StartSnapHelper extends LinearSnapHelper {
    ...
    public StartSnapHelper(int gravity) {
        this(gravity, false, null);
    }

    public StartSnapHelper(int gravity, boolean enableSnapLastItem) {
        this(gravity, enableSnapLastItem, null);
    }

    public StartSnapHelper(int gravity, boolean enableSnapLastItem, SnapListener snapListener) {
