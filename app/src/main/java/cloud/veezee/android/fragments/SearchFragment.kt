...
class SearchFragment : Fragment() {
    ...
    private var searchRecyclerView: androidx.recyclerview.widget.RecyclerView? = null;
    ...
    private fun initializeList() {
        ...
        searchRecyclerView?.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(context, androidx.recyclerview.widget.LinearLayoutManager.VERTICAL, false);
