...
class AudioService : Service() {
    ...
    private fun generateNotification(): Notification? {
        ...
        val playPauseAction: androidx.core.app.NotificationCompat.Action = if (!player?.playWhenReady!!) {
    ...
    private fun mediaSession(): MediaSessionCompat {
        val mediaButtonReceiver = ComponentName(applicationContext, androidx.media.session.MediaButtonReceiver::class.java)
